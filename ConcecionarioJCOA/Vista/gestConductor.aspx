...
<body>
    ...
    <div class="container">
        ...
        <form id="form1" runat="server">
            ...
            <div class="form-group">
                <label for="txtNombreC">Nombre Conductor</label>
                <asp:TextBox ID="txtNombreC" runat="server" class="form-control"></asp:TextBox>
            </div>

            <div class="form-group">
                <label for="txttplic">Tipo de Licencia</label>
                <asp:TextBox ID="txttplic" runat="server" class="form-control"></asp:TextBox>
            </div>
            ...
            <div class="form-group">
                <label for="txtidtpc">Id Tipo Conductor</label>
                <asp:TextBox ID="txtidtpc" runat="server" class="form-control"></asp:TextBox>
            </div>
